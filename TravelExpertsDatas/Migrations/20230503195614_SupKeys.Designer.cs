...
namespace TravelExpertsDatas.Migrations
{
    ...
    [Migration("20230503195614_SupKeys")]
    partial class SupKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelExpertsDatas.Affiliation", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.Agency", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.Agent", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.Booking", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.BookingDetail", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.Class", b =>
                {
                    b.Property<string>("ClassId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExpertsDatas.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsDatas.CustomersReward", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsDatas.Employee", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.Fee", b =>
                {
                    b.Property<string>("FeeId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("TravelExpertsDatas.Package", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsDatas.PackagesProductsSupplier", b =>
                {
                    ...
                    b.HasKey("PackageProductSupplierId")
                        .HasName("PK__Packages__53E8ED99FB5E181D");
                    ...
                    b.HasIndex(new[] { "PackageId", "ProductSupplierId" }, "UQ__Packages__29CA8E950A80A988")
                        .IsUnique();

                    b.ToTable("Packages_Products_Suppliers", (string)null);
                });

            modelBuilder.Entity("TravelExpertsDatas.Product", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.ProductsSupplier", b =>
                {
                    b.Property<int>("ProductSupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsDatas.Region", b =>
                {
                    b.Property<string>("RegionId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExpertsDatas.Reward", b =>
                {
                    b.Property<int>("RewardId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsDatas.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsDatas.SupplierContact", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsDatas.TripType", b =>
                {
                    b.Property<string>("TripTypeId")
                        .HasMaxLength(1)
                        .HasColumnType("nvarchar(1)");
            ...
            modelBuilder.Entity("TravelExpertsDatas.Agent", b =>
                {
                    b.HasOne("TravelExpertsDatas.Agency", "Agency")
                        .WithMany("Agents")
            ...
            modelBuilder.Entity("TravelExpertsDatas.Booking", b =>
                {
                    b.HasOne("TravelExpertsDatas.Customer", "Customer")
                        .WithMany("Bookings")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("Bookings_FK00");

                    b.HasOne("TravelExpertsDatas.Package", "Package")
                        .WithMany("Bookings")
                        .HasForeignKey("PackageId")
                        .HasConstraintName("Bookings_FK01");

                    b.HasOne("TravelExpertsDatas.TripType", "TripType")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("TravelExpertsDatas.Customer", b =>
                {
                    b.HasOne("TravelExpertsDatas.Agent", "Agent")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("TravelExpertsDatas.CustomersReward", b =>
                {
                    ...
                    b.HasOne("TravelExpertsDatas.Reward", "Reward")
                        .WithMany("CustomersRewards")
            ...
            modelBuilder.Entity("TravelExpertsDatas.ProductsSupplier", b =>
                {
                    b.HasOne("TravelExpertsDatas.Product", "Product")
                        .WithMany("ProductsSuppliers")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("Products_Suppliers_FK00");

                    b.HasOne("TravelExpertsDatas.Supplier", "Supplier")
                        .WithMany("ProductsSuppliers")
            ...
            modelBuilder.Entity("TravelExpertsDatas.SupplierContact", b =>
                {
                    b.HasOne("TravelExpertsDatas.Affiliation", "Affiliation")
